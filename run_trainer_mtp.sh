...
add_override "actor.shortest_correct_reward.enabled" "${actor_shortest_correct_reward_enabled}"
add_override "actor.shortest_correct_reward.alpha" "${actor_shortest_correct_reward_alpha}"
add_override "actor.shortest_correct_reward.reward_threshold" "${actor_shortest_correct_reward_reward_threshold}"
add_override "actor.shortest_correct_reward.min_correct" "${actor_shortest_correct_reward_min_correct}"
add_override "actor.shortest_correct_reward.group_size" "${actor_shortest_correct_reward_group_size}"
add_override "actor.shortest_correct_reward.normalize_by_shortest" "${actor_shortest_correct_reward_normalize_by_shortest}"
...
add_override "actor.adaptive_length_reward.group_size" "${actor_adaptive_length_reward_group_size}"
add_override "actor.adaptive_length_reward.min_solve_rate" "${actor_adaptive_length_reward_min_solve_rate}"
add_override "actor.adaptive_length_reward.max_solve_rate" "${actor_adaptive_length_reward_max_solve_rate}"
add_override "actor.adaptive_length_reward.target_quantile" "${actor_adaptive_length_reward_target_quantile}"
add_override "actor.adaptive_length_reward.min_target_len" "${actor_adaptive_length_reward_min_target_len}"
...
add_override "model_scorer.enabled" "${model_scorer_enabled}"
add_override "model_scorer.backend" "${model_scorer_backend}"
add_override "model_scorer.base_url" "${model_scorer_base_url}"
add_override "model_scorer.api_key" "${model_scorer_api_key}"
add_override "model_scorer.model" "${model_scorer_model}"
add_override "model_scorer.timeout_seconds" "${model_scorer_timeout_seconds}"
add_override "model_scorer.max_concurrent_requests" "${model_scorer_max_concurrent_requests}"
add_override "model_scorer.temperature" "${model_scorer_temperature}"
add_override "model_scorer.max_tokens" "${model_scorer_max_tokens}"
add_override "model_scorer.combine_mode" "${model_scorer_combine_mode}"
add_override "model_scorer.weight" "${model_scorer_weight}"
add_override "model_scorer.min_score" "${model_scorer_min_score}"
add_override "model_scorer.max_score" "${model_scorer_max_score}"
add_override "model_scorer.fallback_score" "${model_scorer_fallback_score}"
add_override "model_scorer.input.mode" "${model_scorer_input_mode}"
add_override "model_scorer.input.prompt_tail_tokens" "${model_scorer_input_prompt_tail_tokens}"
add_override "model_scorer.input.completion_tail_tokens" "${model_scorer_input_completion_tail_tokens}"
add_override "model_scorer.input.include_answer" "${model_scorer_input_include_answer}"
add_override "model_scorer.input.include_tests" "${model_scorer_input_include_tests}"
add_override "model_scorer.input.max_field_chars" "${model_scorer_input_max_field_chars}"
add_override "model_scorer.input.system_prompt" "${model_scorer_input_system_prompt}"
