...
class EvalDistributedSampler(DistributedSampler):
    ...
    **Key Behaviors:**
    ...
    .. warning::
        Because different ranks may process a different number of batches, be cautious
        when using collective operations like :func:`torch.distributed.all_gather`.
        You must handle the tensor shape mismatch manually or gather results only after
